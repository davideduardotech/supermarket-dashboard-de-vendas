...
app.layout = html.Div(children=[
    ...
    html.H5("Variáveis de Entrada:"),
    dcc.RadioItems(["Renda Bruta", "Avaliação"], "Renda Bruta", id="main_variable"),
...
# =========== Callback's ===========
@app.callback([Output("city_fig",'figure'),Output("pay_fig",'figure'),Output("income_per_product_fig",'figure')],
              [Input("check_city",'value'),Input("main_variable",'value')])
def render_graphs(cities, main_variable):   
    main_variable = "gross income" if main_variable == "Renda Bruta" else "Rating"
